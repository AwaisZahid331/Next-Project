...
export default function SignupPage() {
  ...
  return (
    ...
    >
      ...
      {/* Card */}
      <div ref={cardRef} className="w-full max-w-md relative rounded-2xl border border-white/10 bg-slate-900/70 backdrop-blur-md shadow-2xl p-8" style={{fontSize:"1rem"}}>
        ...
        <form className="space-y-4" onSubmit={onSubmit}>
          {[
            ...
            <Tippy key={field.id} content={error && index === 2 ? error : null} placement="top" visible={!!error && index === 2}>
